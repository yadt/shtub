...
class StubConfigurationTests (unittest.TestCase):
    ...
    def test_should_convert_dictionary_to_object(self):
        ...
        self.assertEqual(
            CommandInput('any_command', ['any_arg1', 'any_arg2', 'any_argument3'], 'any_stdin'), actual_stub_configuration.command_input)
    ...
    def test_should_create_new_object_with_given_properties_and_answers(self):
        ...
        actual = StubConfiguration(
            'any_command', ['any_arg1', 'any_arg2'], 'any_stdin', answers, 2)
    ...
    def test_should_return_object_as_dictionary(self):
        ...
        expected_command_input = {'command': 'any_command',
                                  ...
                                  'stdin': 'any_stdin'}
        self.assertEqual(
            expected_command_input, actual_dictionary['command_input'])
    ...
    def test_should_set_return_code_and_stderr_and_stdout_and_waiting_time(self):
        stub_configuration = StubConfiguration(
            'any_command', ['any_arg1', 'any_arg2'], 'any_stdin')
        stub_configuration.then_answer(
    ...
    def test_should_allow_with_or_and_input(self):
        ...
        self.assertEqual(
            stub_configuration.with_input, stub_configuration.and_input)
    ...
    def test_should_return_self_when_using_method_then_answer(self):
        ...
        actual_result = stub_configuration.then_answer(
            'Hello world!', 'Hello error', 99)
    ...
    def test_should_return_false_when_comparing_and_current_answer_is_different(self):
        stub_configuration1 = StubConfiguration(
            'any_command', ['any_arg1', 'any_arg2'], 'any_stdin', [], 0)
        stub_configuration2 = StubConfiguration(
            'any_command', ['any_arg1', 'any_arg2'], 'any_stdin', [], 1)
    ...
    def test_should_return_false_when_comparing_and_answers_are_different(self):
        stub_configuration1 = StubConfiguration(
            'any_command', ['any_arg1', 'any_arg2'], 'any_stdin', [Answer('stdout1', 'stderr1', 0)], 0)
        stub_configuration2 = StubConfiguration(
            'any_command', ['any_arg1', 'any_arg2'], 'any_stdin', [Answer('stdout2', 'stderr2', 1)], 0)

        self.assertFalse(
            stub_configuration1 == stub_configuration2, 'comparison error: attribute answers')

    def test_should_return_true_when_comparing_and_stub_configurations_are_equal(self):
        stub_configuration1 = StubConfiguration(
            'any_command', ['any_arg1', 'any_arg2'], 'any_stdin', [Answer('stdout1', 'stderr1', 13)], 1)
        stub_configuration2 = StubConfiguration(
            'any_command', ['any_arg1', 'any_arg2'], 'any_stdin', [Answer('stdout1', 'stderr1', 13)], 1)

        self.assertTrue(
            stub_configuration1 == stub_configuration2, 'comparison error: objects are equal')
    ...
    def test_should_return_string_with_all_properties(self):
        ...
        self.assertEqual(
            "StubConfiguration {'current_answer': 1, 'answers': [{'milliseconds_to_wait': None, 'return_code': 13, 'stderr': 'stderr1', 'stdout': 'stdout1'}], 'command_input': {'stdin': 'any_stdin', 'command': 'any_command', 'arguments': ['any_arg1', 'any_arg2']}}", str(stub_configuration))
