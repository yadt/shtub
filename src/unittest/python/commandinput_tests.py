...
class CommandInputTests (unittest.TestCase):
    def test_should_convert_dictionary_to_object (self):
        ...
        actual_execution = CommandInput.from_dictionary(values)
    ...
    def test_should_create_object_with_given_properties (self):
        actual_execution = CommandInput('any_command', ['any_arg1', 'any_arg2'], 'any_stdin')
    ...
    def test_should_create_object_with_given_properties_but_empty_arguments (self):
        actual_execution = CommandInput('any_command', [], 'any_stdin')
    ...
    def test_should_convert_object_to_dictionary (self):
        execution = CommandInput('any_command', ['any_arg1', 'any_arg2'], 'any_stdin')
    ...
    def test_should_return_false_when_objects_command_is_not_equal (self):
        execution1 = CommandInput('any_command', ['any_arg1', 'any_arg2'], 'any_stdin')
        execution2 = CommandInput('other_command', ['any_arg1', 'any_arg2'], 'any_stdin')
    ...
    def test_should_return_false_when_objects_stdin_is_not_equal (self):
        execution1 = CommandInput('any_command', ['any_arg1', 'any_arg2'], 'any_stdin')
        execution2 = CommandInput('any_command', ['any_arg1', 'any_arg2'], 'other_stdin')
    ...
    def test_should_return_false_when_objects_arguments_are_not_equal (self):
        execution1 = CommandInput('any_command', ['any_arg1', 'any_arg2'], 'any_stdin')
        execution2 = CommandInput('any_command', ['other_argument1', 'any_arg2'], 'any_stdin')
    ...
    def test_should_return_true_when_objects_are_equal (self):
        execution1 = CommandInput('any_command', ['any_arg1', 'any_arg2'], 'any_stdin')
        execution2 = CommandInput('any_command', ['any_arg1', 'any_arg2'], 'any_stdin')
    ...
    def test_should_return_true_when_objects_are_not_equal_and_testing_if_not_equal (self):
        execution1 = CommandInput('any_command', ['any_arg1', 'any_arg2'], 'any_stdin')
        execution2 = CommandInput('other_command', ['other_argument1', 'other_argument2'], 'other_stdin')
    ...
    def test_should_return_string_with_all_properties (self):
        ...
        self.assertEqual("CommandInput {'stdin': 'any_stdin', 'command': 'any_command', 'arguments': ['any_arg1', 'any_arg2']}", str(execution))


    def test_should_return_false_if_other_has_different_arguments (self):
        execution = CommandInput('any_command', ['any_arg1', 'any_arg2'], 'any_stdin')
        other_execution = CommandInput('any_command', ['other_argument1', 'other_argument2'], 'any_stdin')
    ...
    def test_should_return_false_if_other_has_at_least_one_different_argument (self):
        execution = CommandInput('any_command', ['any_arg1', 'any_arg2'], 'any_stdin')
        other_execution = CommandInput('any_command', ['any_arg1', 'any_arg2', 'other_argument'], 'any_stdin')
    ...
    def test_should_return_true_if_other_has_no_arguments (self):
        execution = CommandInput('any_command', ['any_arg1', 'any_arg2'], 'any_stdin')
        other_execution = CommandInput('any_command', [], 'any_stdin')
    ...
    def test_should_return_true_if_other_has_exactly_one_matching_argument_and_no_others (self):
        execution = CommandInput('any_command', ['any_arg1', 'any_arg2'], 'any_stdin')
        other_execution = CommandInput('any_command', ['any_arg1'], 'any_stdin')
    ...
    def test_should_return_true_if_other_has_equal_arguments (self):
        execution = CommandInput('any_command', ['any_arg1', 'any_arg2'], 'any_stdin')
        other_execution = CommandInput('any_command', ['any_arg2', 'any_arg1'], 'any_stdin')
    ...
    def test_should_return_false_when_other_has_different_command_but_equal_arguments (self):
        execution = CommandInput('any_command', ['any_arg1', 'any_arg2'], 'any_stdin')
        other_execution = CommandInput('other_command', ['any_arg2', 'any_arg1'], 'any_stdin')
    ...
    def test_should_return_false_when_other_has_different_stdin (self):
        execution = CommandInput('any_command', ['any_arg1', 'any_arg2'], 'any_stdin')
        other_execution = CommandInput('any_command', ['any_arg1', 'any_arg2'], 'other_stdin')
